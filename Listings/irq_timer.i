...
# 1 "Source/timer\\../tetris_game.h" 1
# 12 "Source/timer\\../tetris_game.h"
//extra2
...
void TIMER1_IRQHandler (void) {
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->IR = 1; // Pulisci flag interrupt

 // Genera Onda Quadra sul DAC
 if (wave_state == 0) {
  ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->DACR = (0x3FF << 6); // Volume Alto (Metà scala)
  wave_state = 1;
 } else {
  ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->DACR = 0; // Volume Basso
  wave_state = 0;
 }
}
void TIMER2_IRQHandler (void) { ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR = 1; }
