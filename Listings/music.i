...
void Music_Init(void) {
 DAC_init();
 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1 << 2);
...
void Play_Note(int frequency, int duration_ticks) {
 ...
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 2; // Reset
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 0;
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR0 = ticks;
 sound_duration = duration_ticks;
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 1; // Start
}
