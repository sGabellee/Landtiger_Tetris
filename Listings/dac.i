...
# 2 "Source/dac/dac.c" 2
# 1 "Source/dac\\dac.h" 1



void DAC_init(void);
# 3 "Source/dac/dac.c" 2
...
void DAC_init(void) {
 ...
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE1 |= (1<<21);
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE1 &= ~(1<<20);
}
